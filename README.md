...
Compare all four algorithms — runs all four algorithms on the same grid at once and charts cells explored vs. path length using Chart.js
...
The web version allows all four algorithms to be compared on the same grid.

![Algorithm Comparison](web/screenshots/comparison.png)
